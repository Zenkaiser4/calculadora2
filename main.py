...
MDScreen:
    ...
    MDBoxLayout:
        ...
        # 1. IMAGEN DEL CAPIBARA (Controlada desde Python para evitar errores en el APK)
        Image:
            id: imagen_capibara
            size_hint_y: 0.25
            allow_stretch: True
...
class CalculadoraCapiApp(MDApp):
    def build(self):
        ...
        # --- SISTEMA DE RUTA ABSOLUTA PARA EL APK ---
        # Encuentra la ubicación interna exacta de la app en Android
        directorio_actual = os.path.dirname(os.path.abspath(__file__))
        # Apunta directamente al archivo "capibara.png" en esa misma carpeta
        ruta_imagen = os.path.join(directorio_actual, "capibara.png")
        
        # Inyecta la ruta al widget de la interfaz de forma segura
        root_widget.ids.imagen_capibara.source = ruta_imagen
